package netcracker.homework.front.view;
...
import netcracker.homework.front.components.ClientEditor;
import org.springframework.beans.factory.annotation.Autowired;
import netcracker.homework.front.repository.ClientRepository;
...
public class MainView extends VerticalLayout {
    ...
    private void showClient(java.lang.String name) {
        if (name.isEmpty()) {
